...
`:"")}},Category=(Category2=>(Category2.CLI="CLI",Category2.CLI_INIT="CLI_INIT",Category2.CLI_AUTOMIGRATE="CLI_AUTOMIGRATE",Category2.CLI_UPGRADE="CLI_UPGRADE",Category2.CLI_ADD="CLI_ADD",Category2.CODEMOD="CODEMOD",Category2.CORE_SERVER="CORE-SERVER",Category2.CSF_PLUGIN="CSF-PLUGIN",Category2.CSF_TOOLS="CSF-TOOLS",Category2.CORE_COMMON="CORE-COMMON",Category2.NODE_LOGGER="NODE-LOGGER",Category2.TELEMETRY="TELEMETRY",Category2.BUILDER_MANAGER="BUILDER-MANAGER",Category2.BUILDER_VITE="BUILDER-VITE",Category2.BUILDER_WEBPACK5="BUILDER-WEBPACK5",Category2.SOURCE_LOADER="SOURCE-LOADER",Category2.POSTINSTALL="POSTINSTALL",Category2.DOCS_TOOLS="DOCS-TOOLS",Category2.CORE_WEBPACK="CORE-WEBPACK",Category2))(Category||{}),NxProjectDetectedError2=class extends StorybookError{constructor(){super(...arguments),this.category="CLI_INIT",this.code=1,this.documentation="https://nx.dev/packages/storybook"}template(){return import_ts_dedent38.default`
    ...
    `}},MissingFrameworkFieldError=class extends StorybookError{constructor(){super(...arguments),this.category="CORE-COMMON",this.code=1,this.documentation="https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#new-framework-api"}template(){return import_ts_dedent38.default`
    ...
    `}},InvalidFrameworkNameError=class extends StorybookError{constructor(data){super(),this.data=data,this.category="CORE-COMMON",this.code=2,this.documentation="https://github.com/storybookjs/storybook/blob/next/MIGRATION.md#new-framework-api"}template(){return import_ts_dedent38.default`
      Invalid value of '${this.data.frameworkName}' in the 'framework' field of Storybook config.

      Please run 'npx storybook@next automigrate' to automatically fix your config.
    `}},CouldNotEvaluateFrameworkError=class extends StorybookError{constructor(data){super(),this.data=data,this.category="CORE-COMMON",this.code=3}template(){return import_ts_dedent38.default`
    ...
    `}},ConflictingStaticDirConfigError=class extends StorybookError{constructor(){super(...arguments),this.category="CORE-SERVER",this.code=1,this.documentation="https://storybook.js.org/docs/react/configure/images-and-assets#serving-static-files-via-storybook-configuration"}template(){return import_ts_dedent38.default`
    ...
    `}},InvalidStoriesEntryError=class extends StorybookError{constructor(){super(...arguments),this.category="CORE-COMMON",this.code=4,this.documentation="https://storybook.js.org/docs/react/faq#can-i-have-a-storybook-with-no-local-stories"}template(){return import_ts_dedent38.default`
