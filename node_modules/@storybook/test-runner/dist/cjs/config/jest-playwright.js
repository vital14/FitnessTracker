...
const getJestPlaywrightConfig = () => {
  const presetBasePath = _path.default.dirname(require.resolve('jest-playwright-preset', {
    paths: [_path.default.join(__dirname, '../../node_modules')]
  }));
  const expectPlaywrightPath = _path.default.dirname(require.resolve('expect-playwright', {
    paths: [_path.default.join(__dirname, '../../node_modules')]
  }));
  return {
    runner: _path.default.join(presetBasePath, 'runner.js'),
    ...
    setupFilesAfterEnv: ['@storybook/test-runner/playwright/jest-setup.js', expectPlaywrightPath, _path.default.join(presetBasePath, 'lib', 'extends.js')]
  };
};
const getJestConfig = () => {
  const {
