...
// node_modules/@imask/svelte/esm/action.js
...
function IMaskAction(el, opts) {
  ...
  function update(opts2) {
    if (!opts2)
      return destroy();
    if (opts2 instanceof IMask.InputMask)
      maskRef = opts2;
    else if (maskRef)
      maskRef.updateOptions(opts2);
    else
      maskRef = initMask(el, opts2);
  }
  return {
    update,
    destroy
...
export {
  IMask,
  IMaskAction as imask
};
//# sourceMappingURL=@imask_svelte.js.map
